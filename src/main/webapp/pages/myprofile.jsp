...
<body class="bg-gray-100">
	...
	<!-- change password modal start -->
		<div id="changepw-modal" class="hidden absolute z-10 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" style="min-width:450px">
    ...
    <!-- wish-list modal start -->
		...
		%>
			<div id="wishlist-popup" class="hidden absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10" style="position: absolute; min-width:650px">
			    <!-- Popup-Card -->
			        ...
			        <div class="bg-gray-50 shadow-md p-1 pr-2 mb-2 rounded-lg">
			        	<div class="flex items-center justify-between space-x-4 mb-4">
			                ...
			                <div class="flex items-center space-x-2">
			                    <a href="/ecommerce/wl-inc-dec?action=dec&id=<%=wl.getRecordId() %>" 
